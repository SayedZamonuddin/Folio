              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Textarea
                    id="problemStatement"
                    rows={4}
                    placeholder="What problem were you solving? What was the context?"
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    id="process"
                    rows={4}
                    placeholder="How did you approach it? What decisions did you make?"
                    {...register("process")}
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Textarea
                    id="outcome"
                    rows={4}
                    placeholder="What were the results? Metrics? What did you learn?"
                    {...register("outcome")}
                  />
                </div>
              </CardContent>
